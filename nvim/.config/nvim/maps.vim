...
" bufferline binding
"===============================================================================
" These commands will navigate through buffers in order regardless 
" of which mode you are using
" e.g. if you change the order of buffers :bnext 
" and :bprevious will not respect the custom ordering
...
" Trigger configuration. You need to change this to something 
" other than <tab> if you use one of the following:
